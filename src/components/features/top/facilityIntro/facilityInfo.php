<div class="pt-16 pb-[100px] flex min-w-[80%] phone:hidden flex-col items-center gap-10">
  ...
  $description = "お子様のゴルフの成長を支援させていただき、誠にありがとうございます。私達は少人数制のグループレッスンを通じて、お子様のゴルフスキルを向上させることを心がけています。また、プロを目指すお子様にはハイレベルまプロ育成コースをご用意し、個々の個性を尊重しながら指導を行っております。<br><br>お子様のゴルフの才能を最大限に引き出すため、一緒に頑張っていきましょう。何かご質問やご要望がありましたら、いつでもお気軽にお知らせください。お子様の素晴らしい成長を共に喜びたいと思っております。";
  $image = $absoluteUriPath . '/asset/junior/junior.png';
  $button = null;
