<div class="pt-16 pb-[100px] flex phone:hidden flex-col gap-10">
  ...
  $description = "ゴルフの基本動作の習得から、スコアを伸ばすための本格的なゴルフレッスンまで指導可能です。
  ゴルフを楽しみたいお子さまも、プロを目指してハイレベルのレッスンを受けたいお子さまにも、それぞれに合った個別指導をおこなっています。";
...
<div class="pt-16 pb-[100px] phone:flex hidden flex-col gap-10">
  ...
  <?php
  $title = "ジュニアゴルフレッスンも大募集！";
  $description = "ゴルフの基本動作の習得から、スコアを伸ばすための本格的なゴルフレッスンまで指導可能です。<br>ゴルフを楽しみたいお子さまも、プロを目指してハイレベルのレッスンを受けたいお子さまにも、それぞれに合った個別指導をおこなっています。";
  $image = $absoluteUriPath . '/asset/junior/junior.png';
  $button = null;
  include $uiPartsPath . '/card/card.phone.php'; ?>
